...
export default function ScheduledMeetings() {
  ...
  const { getScheduledMeetings, updateMeeting, loadScheduledMeetings } =
    useMeetingStore();

	const [scheduledMeetings, setScheduledMeetings] = useState<Meeting[]>([]);

  const handleEditMeeting = async (meetingData: Omit<Meeting, "id" | "status">) => {
	...
	setScheduledMeetings(getScheduledMeetings());
    ...
    <div className="max-w-7xl mx-auto">
      ...
      {editingMeeting && (
        <MeetingForm
          ...
          onSubmit={(meetingData: Omit<Meeting, "id" | "status">) => {
